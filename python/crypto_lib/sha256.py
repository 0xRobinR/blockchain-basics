...
def sum_rot_r_0(x):
    """Perform the sum of right rotate operations with specific shifts."""
...
def sig_rot_r_0(x):
    """Perform the sigma of right rotate operations with specific shifts."""
...
def pad_message(m):
    """Preprocess the message by padding it."""
    m = bytearray(m)
    m_len = len(m) * 8
    m.append(0b10000000)
